...
import { EstimateSelectedClientProps } from '@/src/types/components/pages/estimate'

import styles from './EstimateSelectedClient.module.scss'

const skeltonNum = 5

export default function EstimateSelectedClient(
	props: EstimateSelectedClientProps
) {
	// 選択中の保険プランの保険料合計
